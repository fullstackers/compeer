...
Packet.init = function () {
  ...
  if (!arguments.length) throw new TypeError('pack must not be null');
  var args = slice.call(arguments);
  var pack = args.shift();
  var head, body, type, id;
  if (!(pack instanceof Packet)) throw new TypeError('pack must be a Packet');
